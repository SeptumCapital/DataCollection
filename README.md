...
```text
SENQUANT_EXTERNAL_LLM_BASE_URL=https://api.runpod.ai/v2/qwen3-32b-awq
SENQUANT_EXTERNAL_LLM_API_KEY=<set only in Render env vars>
SENQUANT_EXTERNAL_LLM_MODEL=qwen3-32b-awq
SENQUANT_EXTERNAL_LLM_API_STYLE=runpod
SENQUANT_EXTERNAL_LLM_TIMEOUT_SECONDS=90
SENQUANT_EXTERNAL_LLM_MAX_TOKENS=260
```

For OpenAI-compatible RunPod vLLM endpoints, use `SENQUANT_EXTERNAL_LLM_API_STYLE=openai` and set the base URL to `https://api.runpod.ai/v2/<endpoint-id>/openai/v1`.
